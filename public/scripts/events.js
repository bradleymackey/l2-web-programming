$("#event-search").submit( (event) => {
  ...
  $.get(`http://api.eventful.com/json/events/search?app_key=pPHmxHj5PpbfrP9s&keywords=${searchParams.search}&location=United+Kingdom&date=Future&page_size=8`, (data) => {
